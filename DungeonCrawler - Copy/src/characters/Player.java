...
public class Player extends gameObject {
    ...
    public int getAttack(){
        ...
        int baseAttack = strength * currentWeapon.attackValue;

        // Check if the current weapon is an axe
        if (currentWeapon.type == type_axe) {
            // Add additional attack bonus based on player's level
            int additionalAttack = level * 1; // Adjust as needed
    ...
    public void getPlayerImage() {
        up1 = setup("/player/walkUp1", gp.tileSize, gp.tileSize);
        up2 = setup("/player/walkUp2", gp.tileSize, gp.tileSize);
        down1 = setup("/player/walkDown1", gp.tileSize, gp.tileSize);
        down2 = setup("/player/walkDown2", gp.tileSize, gp.tileSize);
        left1 = setup("/player/walkLeft1", gp.tileSize, gp.tileSize);
        left2 = setup("/player/walkleft2", gp.tileSize, gp.tileSize);
        right1 = setup("/player/Char1walk", gp.tileSize, gp.tileSize);
        right2 = setup("/player/Char1Walk1", gp.tileSize, gp.tileSize);
    }
